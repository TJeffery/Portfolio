...
{{--        @endforeach--}}
        ...
        <div class=" min-h-36 flex flex-row justify-center items-center my-20 mx-10 gap-10 shadow-2xl   ">
            ...
            <div class="  w-1/2 mb-5">
                <h1 class="font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-sky-100 via-[#80A5AB] to-[#80A5AB]">
                    <a href="https://www.griffith.edu.au/study/degrees/master-of-information-technology-5612"> University of Canberra - Bachelors/Honours </a>
                </h1>
                <p class="font-l text-sky-100">
                    Ranked in the top 10 universities in Australia, Universtiy of Canberra taught me everything needed for game development, and more than prepared me for Masters.
                    Projects focus on practical assessments in developing projects at all stages of study. My studies went through a bachelors and Honors degree.
                </p>
            </div>
